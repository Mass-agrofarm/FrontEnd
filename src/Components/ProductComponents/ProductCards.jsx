    ...
    <div className="cards-container">
          <div className="product-card">
            <div className="product-top">
              <img className='product-img' src='https://fakeimg.pl/353x252/c5c5c5/959595?text=Mass+Agro+Farm+Product&font=museo&font_size=24&retina=1' alt='Mass Agro farm product'/>
              <h3>product name.</h3>
            </div>
